...
export const SOIL_VARIABLES = [
  ...
  {
    key: "aws0100wta",
    label: "Available Water Storage (0–100 cm)",
    type: "continuous",
    description: "SSURGO available water storage in the top 100 cm of soil, map-unit weighted average.",
    unit: "cm",
  },
  {
    key: "slopegraddcp",
    ...
    type: "continuous",
    description: "SSURGO average slope gradient, dominant component.",
    unit: "%",
  },
  {
    key: "awmmfpwwta",
    label: "Available Water to Most Limiting Layer",
    type: "continuous",
    description: "SSURGO available water storage fraction to the most limiting soil layer, map-unit weighted average.",
    unit: null,
  },
  {
    key: "drclassdcd",
    ...
    type: "categorical",
    description: "SSURGO qualitative drainage class, dominant condition.",
    unit: null,
  },
  {
    key: "hydgrpdcd",
    ...
    type: "categorical",
    description: "SSURGO hydrologic soil group (A-D), dominant condition - A drains fastest, D is most runoff-prone.",
    unit: null,
  },
];
